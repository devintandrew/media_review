...
class ContentsTest < ApplicationSystemTestCase
  ...
  test "creating a Content" do
    ...
    fill_in "Content review notes", with: @content.content_review_notes
    fill_in "Content type", with: @content.content_type
    fill_in "Movie link", with: @content.movie_link
    fill_in "Rating", with: @content.rating
    fill_in "Release date", with: @content.release_date
